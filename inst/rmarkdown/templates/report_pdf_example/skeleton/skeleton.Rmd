...
# The dataframe iris is available in R's dataset package that is automatically loaded when you start R
# Subset the data
...
```{r analysis, echo = TRUE, results = 'markup', fig.keep='none', message = FALSE, error = FALSE, size='tiny'}
```
